    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('LocationCode') ?></th>
                <th scope="col"><?= $this->Paginator->sort('LocationName') ?></th>
                <th scope="col"><?= $this->Paginator->sort('AllowAccessLevel') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($location->LocationCode) ?></td>
                <td><?= h($location->LocationName) ?></td>
                <td><?= $this->Number->format($location->AllowAccessLevel) ?></td>
